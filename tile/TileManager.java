...
public class TileManager {
    ...
    public void getTileImage()
    {
        ...
        {
            tile[0] = new Tile();
            tile[0].image = ImageIO.read(getClass().getResourceAsStream("./../src/tiles/grass00.png"));
            ...
            tile[2] = new Tile();
            tile[2].image = ImageIO.read(getClass().getResourceAsStream("./../src/tiles/water00.png"));
